 ...
 * XDoclet definition:
 * 
 * @struts.action path="/PostFeedbackAction" name="GeneralFormBean"
 *                input="/FeedBack.jsp" scope="request" validate="true"
 * @struts.action-forward name="success" path="/FeedBack.jsp"
 */
public class PostFeedbackAction extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		// Auto-generated
		// method
		Feedback feedback = new Feedback(generalFormBean); // stub
		boolean flag = false;
		try {
			flag = new GeneralDelegate().addFeedback(feedback);
			request.setAttribute(UtilConstants._STATUS,
					UtilConstants._FEEDBACK_SUCCESS);
			...
			request.setAttribute(UtilConstants._STATUS,
					UtilConstants._FEEDBACK_FAILURE);
			return mapping.findForward(UtilConstants._SUCCESS);
		}

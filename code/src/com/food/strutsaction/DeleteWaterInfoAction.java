 ...
 */
public class DeleteWaterInfoAction extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			for (int i = 0; i < ch.length; i++) {
				...
				flag = new FoodDelegate()
						.deleteFoodInformation(Integer.parseInt(ch[i]));
			}
			if (flag) {
				request.setAttribute(UtilConstants._STATUS, request
						.getParameter("water")
						+ " Information Deleted SuddessFully........");

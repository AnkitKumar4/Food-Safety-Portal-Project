 ...
 */
public class DeleteEnquiryQuestionAction extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			for (int i = 0; i < ch.length; i++) {
				...
				flag = new GeneralDelegate().deleteEnquiryQuestion(Integer
						.parseInt(ch[i]));
			}
			if (flag) {
				request.setAttribute(UtilConstants._STATUS,
						UtilConstants._DELETE_ENQUIRY_SUCCESS);
				return mapping.findForward(UtilConstants._SUCCESS);
			} else {
				request.setAttribute(UtilConstants._STATUS,
						UtilConstants._DELETE_ENQUIRY_FAILURE);
				return mapping.findForward(UtilConstants._SUCCESS);

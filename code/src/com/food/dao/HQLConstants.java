...
public class HQLConstants {
	...
	public static final String _FOOD_SUPPLY = "from Restaurant where cityidref=?";
	public static final String _FOOD_INFORMATION = "from FoodInfoPojo where cityid=? and INFORMATIONTYPE=?";

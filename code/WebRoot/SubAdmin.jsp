			...
			<li class="top">
				...
				<ul class="sub">
					<li>
						...
						<ul>
							<li>
								<a href="./AddRestaurentDetils.jsp"><span>AddCityRestaurents</span>
								</a>
							</li>
							<li>
					...
					<li class="mid">
						...
						<ul>
							<li>
								<a href="./AddFoodInformation.jsp?food=Guide" class="parent"><span>AddFoodHandlingGuide</span>
								</a>
							</li>
							<li>
								<a href="./ViewAdminFoodInfoAction.do?food=Guide" class="parent"><span>ViewFoodHandlingGuide</span>
								</a>
							</li>
					...
					<li class="mid">
						...
						<ul>
							<li>
								<a href="./AddFoodInformation.jsp?food=Reports" class="parent"><span>AddVitaminAnalysisReports</span>
								</a>
							</li>
							<li>
					...
					<li class="mid">
						...
						<ul>
							<li>
								<a href="./AddFoodInformation.jsp?food=Quality" class="parent"><span>AddFoodQuality</span>
								</a>
							</li>
							<li>

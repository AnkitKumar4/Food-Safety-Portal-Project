	...
	<body bgcolor='skyblue'>
		<ul id="nav">
			<li class="top">
				...
				<ul class="sub">
					<li>
						<a href="./UserRegistrationForm.jsp" class="parent"><span>AdminRegistration</span>
						</a>
					</li>
					<li>
			...
			<li class="top">
				...
				<ul class="sub">
					<li>
						...
						<ul>
							<li>
								<a href="./AddState.jsp"><span>AddStates</span> </a>
							</li>
							<li>
					...
					<li class="mid">
						...
						<ul>
							<li>
								<a href="./districtViewStateAction.do" class="parent"><span>AddDistrict</span>
								</a>
							</li>
							<li>
					...
					<li class="mid">
						...
						<ul>
							<li>
								<a href="./CityViewStateAction.do" class="parent"><span>AddCity</span>
								</a>
							</li>
							<li>
			...
			<li class="top">
				...
				<ul class="sub">
					<li>
						<a href="./AddEducationDetails.jsp" class="parent"><span>AddStudiesInfo</span>
						</a>
					</li>
					<li>
			...
			<li class="top">
				...
				<ul class="sub">
					...
					<li class="mid">
						...
						<ul>
							<li>
								<a href="./AddFoodInformation.jsp?food=Diet" class="parent"><span>AddLocalDiet</span>
								</a>
							</li>
							<li>
								<a href="./ViewAdminFoodInfoAction.do?food=Diet" class="parent"><span>ViewLocalDiet</span>
								</a>
							</li>
					...
					<li class="mid">
						...
						<ul>
							<li>
								<a href="./AddFoodInformation.jsp?food=FoodHandlingGuide"
									class="parent"><span>AddFoodHandlingGuide</span> </a>
							</li>
							<li>
								<a href="./ViewAdminFoodInfoAction.do?food=FoodHandlingGuide"
					...
					<li class="mid">
						...
						<ul>
							<li>
								<a href="./AddFoodInformation.jsp?food=VitaminReports"
									class="parent"><span>AddVitaminAnalysisReports</span> </a>
							</li>
							<li>
								<a href="./ViewAdminFoodInfoAction.do?food=VitaminReports"
					...
					<li class="mid">
						...
						<ul>
							<li>
								<a href="./AddFoodInformation.jsp?food=SafetyInstructions"
									class="parent"><span>AddFoodsafetyInstructions</span> </a>
							</li>
							<li>
					...
					<li class="mid">
						...
						<ul>
							<li>
								<a href="./AddFoodInformation.jsp?food=FoodQuality"
									class="parent"><span>AddFoodQuality</span> </a>
							</li>
							<li>
								<a href="./ViewAdminFoodInfoAction.do?food=FoodQuality"

...
.Title1 {
	...
	font-size: 8pt
		...
		<body>
			...
			<form action="./UpdateWaterSupplyDetailsAction.do" method="post"
				name="supply">
				<!--<table border="1"><tr><td></td></tr></table>-->
				<table border="0" align="center">
					<c:if test="${not empty waterSupply}">
						<tr>
							<td align='right'>
								Name of the Colony/Locality
							</td>
							<td>
								<input type="text" name="colonyname"
									value="${waterSupply.colonyname}" />
						...
						<tr>
							...
							<td>
								<select name="division">
									<option value="${waterSupply.division}" selected="true">
										<font size="3" face="Verdana">${waterSupply.division}</font>
									</option>
									<option value="I">
						...
						<tr>
							...
							<td>
								<select name="areatype">
									<option value="${waterSupply.areatype}" selected="true">
										<font size="3" face="Verdana">${waterSupply.areatype}</font>
									</option>
									<option value="Slum">
						...
						<tr>
							...
							<td>
								<input type="text" name="fromtime"
									value="${waterSupply.fromtime}" size="20" />
								(12:00AM/PM)
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input type="text" name="totime" value="${waterSupply.totime}"
									size="20" />
								(12:00AM/PM)
							</td>
						</tr>
						<tr>
							...
							<td>
								<select name="supplypattrn">
									<option value="${waterSupply.supplypattrn}" selected="true">
										<font size="3" face="Verdana">${waterSupply.supplypattrn}</font>
									</option>
									<option value="Daily">
						...
						<tr>
							...
							<td>
								<input type="text" name="lineman" value="${waterSupply.lineman}"
									size="20" />
							</td>
						</tr>
						<tr>
							...
							<td>
								<input type="text" name="contactaddresses"
									value="${waterSupply.contactaddresses}" size="20" />
								<input type='hidden' name='cityidref'
									value='${sessionScope.cityid}' />
								<input type='hidden' name='supplyid'
									value='${waterSupply.supplyid}' />
							</td>
						</tr>
						<tr>
							<td></td>
